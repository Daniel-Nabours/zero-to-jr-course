...
const Home: NextPage = () => {
  return (
    <div>
      ...
      <p>
        To start, we need to initialize a repo. For our purposes, I’ve created a
        shell project you can clone that is already bootstrapped and ready to
        run in the browser. You’re welcome. 
      </p>

      <p>Open your terminal in VSCode and type <code>git clone ((URL))</code> </p>
      ...
      <p>
        If you don’t have a repo to clone, you can create your own by using the
        <code>git init</code> command, now you’ll be able to connect to the remote
        repository by using <code>git remote add origin ((URL))</code>. This will push your
        local folder to the repository located at the specified url.
      </p>
