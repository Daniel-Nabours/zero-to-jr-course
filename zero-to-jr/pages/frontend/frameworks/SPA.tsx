  ...
  return (
    <div className="content">
      <div className="section">
        ...
        <p>
          Single page applications are applications that exist solely on a
          single page. They work by conditionally rendering different content
          based off the current state of the application. Although fast,
          elegant, and easy to use, they do run into a number of problems.
        </p>
        ...
        <p>Some common SPA frameworks include Create-React-App and Vite.</p>
      </div>
    </div>
  );
};
