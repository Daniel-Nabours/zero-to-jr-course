    ...
    <div className="content">
      ...
      <div className="content section">
        ...
        <p>
          ...
          of CSS declarations that you want to reuse throughout your site. Think
        ...
        <div>{mixins2}</div>
        <p>
          By doing this, you can keep your CSS as dry as possible and allow for
          more concise theme definitions reflected across the application.
        </p>
      </div>
    </div>
  );
