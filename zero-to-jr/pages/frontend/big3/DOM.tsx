  ...
  return (
    <div className="content">
      ...
      <p>
        ...
        represent a document as a hierarchical structure of objects. To explain
        in more detail:
      </p>
      ...
      <p>
        {" "}
        In DOM each element is represented as an object. The document itself is
        an object. Each object can have child objects (the p, h1 and img in the
        above example are children of the parent document; the span element is a
        child of the second p element). An object can also have attributes (src
        and alt are attributes of the img element object; &apos;This is
        text&apos; is the text attribute of the p element object).
      </p>

      <p>
        Because these markup languages allow for nested (child) elements, the
        whole thing can be represented as a tree structure, which is the model.
      </p>
      ...
      <p>
        ...
        doesn&apos;t change the actual HTML file. For XML documents you usually
        use an XML parsing library with your programming language of choice, and
        navigate the DOM structure using code.
      </p>
    </div>
  );
};
