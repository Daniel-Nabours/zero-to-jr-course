  ...
  return (
    <div className="content">
      <div className="section">
        ...
        <Image placeholder="blur" src={trie} alt="A tree data structure" />
        <h2>Hash map</h2>
        <p>
        ...
        <Image placeholder="blur" src={hash} alt="an example of a hash map" />
        <h2>Graph</h2>
        <p>
        ...
        <Image
          placeholder="blur"
          src={graph}
          alt="an example of a graph structure"
        />
      </div>
    </div>
  );
